"""Constrói scene.blend do T2 AB (Ocean Side) — headless.

Uso:
    source pipeline/env.sh
    $BLENDER -b --factory-startup -P projects/ocean-side/model_t2.py -- --stage geometry --save --qa
...
def parse_args(argv):
    ...
    p.add_argument("--save", action="store_true", help="grava projects/ocean-side/scene.blend")
